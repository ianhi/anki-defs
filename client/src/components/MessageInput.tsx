...
export function MessageInput({
  ...
  // Show informational hint for multi-word input without highlights (non-English→target)
  const showSentenceHint = !isEnglishToTarget && hasSpaces && highlightedWords.length === 0;
